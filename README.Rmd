...
You can download the compendium as a zip from from this URL: <https://github.com/jjmaynard/Global.Pedons/archive/master.zip>

Or you can install this compendium as an R package, Global.Pedons, from GitHub with:
