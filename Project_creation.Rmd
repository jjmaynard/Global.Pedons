...
name <- "Global.Pedons"
path <- "C:/R_Drive/Data_Files/LPKS_Data/R_Projects/Global.Pedons"
```
...
```{r}
rrtools::use_compendium("Global.Pedons")
usethis::use_mit_license(name = "Jonathan J Maynard")
usethis::use_git()
#Create github ‘repo’ token for “myproject”
usethis::use_github(auth_token = "2439a8823ffe0e2141bfe8dd9a4802cbd87ac96b", protocol = "https", private = FALSE)
